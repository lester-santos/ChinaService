...
namespace MaxiFlexProxy
{
    ...
    [ServiceContract]
    public interface IMaxiFlexData
    {
        [OperationContract]
        void DoWork();
        ...
        [OperationContract]
        byte[] DownloadCardDesign(string Filename);

        [OperationContract]
        bool SetSecurityQuestion(string secQuestions);

        [OperationContract]
        string GetSecurityQuestion(string IDNo);

        [OperationContract]
        bool ChangeCardNo(string IDNo);

        [OperationContract]
        byte[] byteLOApdf(string ClaimNo, string UserID);

        [OperationContract]
        byte[] downloadImage(string Filename);

        [OperationContract]
        bool uploadImage(string _filename, byte[] img);
    }
